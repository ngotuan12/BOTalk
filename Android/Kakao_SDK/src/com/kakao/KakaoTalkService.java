...
public class KakaoTalkService {
    ...
    public static void requestProfile(final KakaoTalkHttpResponseHandler<KakaoTalkProfile> responseHandler) {
        ...
        APIHttpRequestTask.checkSessionAndExecute(new APIHttpRequestTask<KakaoTalkProfile>(requestBuilder.build(), responseHandler, KakaoTalkProfile.class), responseHandler);
    }
}
