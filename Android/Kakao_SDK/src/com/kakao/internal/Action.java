...
public class Action {
    ...
    private Action(final ACTION_TYPE type, final String url, final ActionInfo[] actionInfos) throws KakaoParameterException {
        if (type == null) {
    ...
    public static Action newActionApp(final ActionInfo[] actionInfos) throws KakaoParameterException {
