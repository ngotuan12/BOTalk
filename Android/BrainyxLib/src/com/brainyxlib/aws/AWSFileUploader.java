...
public class AWSFileUploader extends AsyncTask<Void, Integer, Boolean>{
	...
	protected Boolean doInBackground(Void... params) {
		try {
		      ...
		      putObjectRequest = new PutObjectRequest(bucketname, msgkey+ "/"+uploadfile.getName(),uploadfile);
	          ...
	          resultPath = "http://s3-" + s3.getBucketLocation(bucketname)+".amazonaws.com/"+bucketname+"/"+msgkey+"/"+uploadfile.getName();
