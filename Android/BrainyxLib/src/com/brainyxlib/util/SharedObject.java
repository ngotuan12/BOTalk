...
public class SharedObject {
	public static final String APP_CODE = "ucs";
	...
	public static void ClearProperty(Context context,String property){
		SharedPreferences pref = context.getSharedPreferences(APP_CODE, 0);
		Editor ed = pref.edit();
		ed.remove(property);
		ed.commit();
	}
